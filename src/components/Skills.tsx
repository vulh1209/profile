...
const Skills = () => {
  ...
  // Key expertise areas for summary section
  const expertiseAreas = [
    ...
    },
    {
      ...
      description:
        "EVM blockchain development and secure smart contract implementation",
      icon: "⛓️",
    },
    {
      title: "Cloud Architecture",
      description:
        "AWS infrastructure, Kubernetes orchestration, and scalable solutions",
      icon: "☁️",
    },
    {
  ...
  return (
    <section
      id="skills"
      className="py-20 bg-gradient-to-b from-transparent via-gray-900/20 to-transparent relative"
    >
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Rotating border elements for visual interest */}
        <motion.div
      ...
      <div className="container-max-width section-padding relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
            Comprehensive expertise in full stack development, blockchain
            ...
            >
              ...
              <div className="flex items-center mb-8">
                <div className="p-3 bg-black/30 rounded-xl border border-gray-600/50 mr-4 group-hover:border-gray-500/70 transition-colors duration-300">
                  <category.icon
                    className={`w-6 h-6 ${category.color} group-hover:text-white transition-colors duration-300`}
                  />
                </div>
